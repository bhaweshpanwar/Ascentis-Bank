const UserReview = () => {
    const reviews = [
        ...
        {
            name: "Neha Gupta",
            review: "Fantastic products and top-notch support. Will recommend to all.",
                ...
                <div className="w-full max-w-screen-2xl m-auto px-6">
                    <div className="transition duration-500 ease-in-out transform scale-100 translate-x-0 translate-y-0 opacity-100">
                        <div className="mb-12 space-y-5 md:mb-16 md:text-center">
                            ...
                            <h1 className="mb-5 text-3xl text-[#2B3031] font-SF_PRO_Light  md:text-center md:text-5xl"
                                // style={{
                                //     background:
                        ...
                        {reviews.map((review, index) => (
                            <div key={index} className="text-sm leading-6">
                                <div className="relative">
                                    <div className="relative p-6 space-y-6 leading-none rounded-[20px] bg-[#F2F3F5] shadow-md">
                                        <div className="flex items-center space-x-4">
                                            ...
                                            />
                                            <div>
                                                <h3 className="text-lg font-SF_Pro_Regular text-black">{review.name}</h3>
                                            </div>
                                        </div>
                                        <p className="leading-normal font-SF_PRO_Light text-gray-700 text-[18px]">{review.review}</p>
                                    </div>
                                </div>
                            </div>
                        ))}
