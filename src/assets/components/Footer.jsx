const Footer = () => {
    return (
        <footer className=" rounded-3xl mb-10 w-full max-w-screen-2xl m-auto font-SF_PRO_Light"
        style={{
            ...
            <div className="container mx-auto p-6 md:p-8 xl:px-0">
                <div className="mx-auto max-w-screen-2xl px-6 pb-10 pt-16">
                        ...
                        <div className="grid grid-cols-2 gap-8 xl:col-span-2">
                            <div>
                                ...
                                <ul className="mt-6 space-y-4">
                                    <li>
                                        <a href="/personal-banking" className="text-md text-gray-600 hover:text-gray-800">Personal Banking</a>
                                    </li>
                                    <li>
                                        <a href="/business-banking" className="text-md text-gray-600 hover:text-gray-800">Business Banking</a>
                                    </li>
                                    <li>
                                        <a href="/investment-services" className="text-md text-gray-600 hover:text-gray-800">Investment Services</a>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                <h3 className="text-md font-semibold leading-6 text-black">Use Cases</h3>
                                <ul className="mt-6 space-y-4">
                                    <li>
                                        <a href="/loans" className="text-md text-gray-600 hover:text-gray-800">Loans</a>
                                    </li>
                                    <li>
                                        <a href="/credit-cards" className="text-md text-gray-600 hover:text-gray-800">Credit Cards</a>
                                    </li>
                                    <li>
                                        <a href="/online-mobile-banking" className="text-md text-gray-600 hover:text-gray-800">Online & Mobile Banking</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    {/* Footer Bottom */}
                    <div className="mt-16 border-t border-gray-200/30 pt-8 text-center">
